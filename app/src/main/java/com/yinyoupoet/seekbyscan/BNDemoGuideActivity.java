...
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigatorActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(NavigatorActivity.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
    ...
    protected void onDestroy() {
        ...
        NavigatorActivity.activityList.remove(this);
